...
INCLUDE += -I. -Isdk -I$(SMSDK)/public -I$(SMSDK)/public/sourcepawn

LINK_HL2 = $(HL2LIB)/tier1_i486.a $(HL2LIB)/interfaces_i486.a $(LIB_PREFIX)vstdlib$(LIB_SUFFIX) $(LIB_PREFIX)tier0$(LIB_SUFFIX)
...
CPPFLAGS += -std=c++11 -Wno-non-virtual-dtor -fno-exceptions -fno-rtti
